public class NumberToWords {
    public static void numberToWords(int number){
        ...
        int countOrigNum = getDigitCount(number);
                    number = reverse(number);
            int convertedNum = getDigitCount(number);
            String stringedDigit = "";
            if(number == 0) {
                stringedDigit = "Zero";
            } else {
            ...
            for(int j = 0; j < (countOrigNum - convertedNum); j++){
                    stringedDigit += "Zero ";
                }
            }
            System.out.println(stringedDigit);
        }
